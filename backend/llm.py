...
_MOCK_RESPONSES = {
    ...
    "cross_slide_aggregator": '{"synthesis_a": "Histo-A (Qwen 72B) cross-slide read: multifocal infiltrating ductal carcinoma across 8/12 slides. Consolidated SBR grade III with extensive lymphovascular and perineural invasion. Anterior margin involved (R1, 0.5mm).", "synthesis_b": "Histo-B (Meditron 70B) cross-slide read: pancreatic acinar adenocarcinoma variant, dominant grade II with focal grade III foci on slides 1 and 9. Margin assessed as close (1mm) but uninvolved — recommends step-section confirmation before R1 declaration.", "dominant_pattern": "infiltrating ductal/acinar carcinoma of the pancreas", "affected_slides": [0, 1, 2, 3, 4, 5, 8, 9], "disagreements": ["Grade: Histo-A consolidated grade III, Histo-B grade II with focal grade III — requires arbitration", "Margin status: Histo-A R1 anterior involved, Histo-B R0 close (1mm) — step-section recommended", "Histological subtype: Histo-A favors classical IDC, Histo-B identifies acinar variant features"], "confidence": 0.89, "thinking": "Two readers diverge on grade and margin. Acinar variant pattern suggested by Histo-B should be evaluated against IHC."}',
